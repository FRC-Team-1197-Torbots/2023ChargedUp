...
public final class Constants {
  public static class DriveTrainConstants {
    public static final int LeftTopID = 3;
    public static final int LeftBottom1ID = 4;
    public static final int LeftBottom2ID = 5;

    public static final int RightTopID = 13;
  ...
  public static class TeleopDriveConstants{
    ...
    public static final double MAX_VELOCITY = 17000f;//50000f;//45000f; //28000 //39000 // 34,000 // 39,000
